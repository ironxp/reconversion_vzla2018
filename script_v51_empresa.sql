/*
Reconversion de datos valorizados (montos), dividos entre 1000 y redondeados a 2 decimales.
Identificar la Base de Datos de la empresa segun la Version: Ejm. "apbase" - "dpadmwin" - "dpsgev51"
*/
...
ATV_COSADQ=ROUND((ATV_COSADQ/1000),2), 
...
ACC_MONTO=ROUND((ACC_MONTO/1000),2);

UPDATE DPASIENTOS SET 
MOC_MONTO=ROUND((MOC_MONTO/1000),2),
MOC_VALCAM=ROUND((MOC_VALCAM/1000),2);

UPDATE DPASIENTOSPRE SET 
ASP_MONTO=ROUND((ASP_MONTO/1000),2);					  
...
ECB_MONTO=ROUND((ECB_MONTO/1000),2),
ECB_SALDO=ROUND((ECB_SALDO/1000),2),
ECB_DEBE=ROUND((ECB_DEBE/1000),2),
ECB_HABER=ROUND((ECB_HABER/1000),2);

UPDATE DPCAJAMOV SET 
CAJ_MONTO=ROUND((CAJ_MONTO/1000),2),
CAJ_VALCAM=ROUND((CAJ_VALCAM/1000),2),
CAJ_MTOIMP=ROUND((CAJ_MTOIMP/1000),2);

UPDATE DPCAJATRANSF SET 
TDC_MONTO=ROUND((TDC_MONTO/1000),2);

UPDATE DPCBTEPAGO SET 
PAG_VALCAM=ROUND((PAG_VALCAM/1000),2),
PAG_MONTO=ROUND((PAG_MONTO/1000),2),
PAG_MTOIVA=ROUND((PAG_MTOIVA/1000),2);

UPDATE DPCLIENTEPROG SET 
DPG_MONTO=ROUND((DPG_MONTO/1000),2), 
DPG_MTOORG=ROUND((DPG_MTOORG/1000),2);

UPDATE DPCLIENTES SET 
CLI_LIMITE=ROUND((CLI_LIMITE/1000),2),
CLI_MTOVEN=ROUND((CLI_MTOVEN/1000),2),
CLI_CAPSUS=ROUND((CLI_CAPSUS/1000),2),
CLI_CAPPAG=ROUND((CLI_CAPPAG/1000),2);

UPDATE DPCLIENTESCERO SET 
CCG_LIMITE=ROUND((CCG_LIMITE/1000),2),
CCG_MTOVEN=ROUND((CCG_MTOVEN/1000),2),
CCG_CAPSUS=ROUND((CCG_CAPSUS/1000),2),
CCG_CAPPAG=ROUND((CCG_CAPPAG/1000),2);

UPDATE DPCLIENTESISLR SET 
RAI_MONTO=ROUND((RAI_MONTO/1000),2);

UPDATE DPCLIENTESSUC SET 
SDC_VIATIC=ROUND((SDC_VIATIC/1000),2);

UPDATE DPCOMPVALORAGRE SET 
CVA_MONTO=ROUND((CVA_MONTO/1000),2);

UPDATE DPCTABANCOCON SET 
MOB_VALCAM=ROUND((MOB_VALCAM/1000),2),
MOB_MONTO=ROUND((MOB_MONTO/1000),2),
MOB_MONNAC=ROUND((MOB_MONNAC/1000),2),
MOB_MTOIDB=ROUND((MOB_MTOIDB/1000),2),
MOB_MTOIMP=ROUND((MOB_MTOIMP/1000),2),
MOB_MTOCOM=ROUND((MOB_MTOCOM/1000),2);
...
MOB_MTOIMP=ROUND((MOB_MTOIMP/1000),2),
MOB_MTOCOM=ROUND((MOB_MTOCOM/1000),2),
MOB_SLDBCO=ROUND((MOB_SLDBCO/1000),2);

UPDATE DPCTABCOEDOE SET 
ECE_MONTO=ROUND((ECE_MONTO/1000),2),
ECE_SALDO=ROUND((ECE_SALDO/1000),2);

UPDATE DPDEPRECIAACT SET 
DEP_MONTO=ROUND((DEP_MONTO/1000),2),
DEP_MTOORG=ROUND((DEP_MTOORG/1000),2),
DEP_MTOFS=ROUND((DEP_MTOFS/1000),2),
DEP_MTOFN=ROUND((DEP_MTOFN/1000),2),
DEP_MTOFIS=ROUND((DEP_MTOFIS/1000),2),
DEP_MTOFIN=ROUND((DEP_MTOFIN/1000),2),
DEP_DEPFIN=ROUND((DEP_DEPFIN/1000),2),
...
UPDATE DPDOCCLI SET 
DOC_NETO=ROUND((DOC_NETO/1000),2),
DOC_OTROS=ROUND((DOC_OTROS/1000),2),
DOC_IMPOTR=ROUND((DOC_IMPOTR/1000),2),
DOC_VALCAM=ROUND((DOC_VALCAM/1000),2),
DOC_MTOCOM=ROUND((DOC_MTOCOM/1000),2),
DOC_BASNET=ROUND((DOC_BASNET/1000),2),
DOC_MTOIVA=ROUND((DOC_MTOIVA/1000),2),
DOC_MTOEXE=ROUND((DOC_MTOEXE/1000),2);

UPDATE DPDOCCLICTA SET 
CCD_MONTO=ROUND((CCD_MONTO/1000),2),
CCD_TOTAL=ROUND((CCD_TOTAL/1000),2);

UPDATE DPDOCCLIISLR SET 
RXC_MTOBAS=ROUND((RXC_MTOBAS/1000),2),
RXC_MTOSUJ=ROUND((RXC_MTOSUJ/1000),2),
RXC_MTODED=ROUND((RXC_MTODED/1000),2),
RXC_MTORET=ROUND((RXC_MTORET/1000),2);

UPDATE DPDOCCLIIVA SET 
IXD_MTOBAS=ROUND((IXD_MTOBAS/1000),2),
IXD_MTOIVA=ROUND((IXD_MTOIVA/1000),2);

UPDATE DPDOCCLIPROG SET 
PLC_MONTO=ROUND((PLC_MONTO/1000),2);
...
AUP_MONTO=ROUND((AUP_MONTO/1000),2);
...
DCG_MONTO=ROUND((DCG_MONTO/1000),2),
DCG_MTODIV=ROUND((DCG_MTODIV/1000),2),
DCG_VALDIV=ROUND((DCG_VALDIV/1000),2);

UPDATE DPDOCPROGASXINV SET 
DXI_MONTO=ROUND((DXI_MONTO/1000),2);

UPDATE DPDOCPROISLR SET 
RXP_MTOBAS=ROUND((RXP_MTOBAS/1000),2),
RXP_MTOSUJ=ROUND((RXP_MTOSUJ/1000),2),
RXP_MTODED=ROUND((RXP_MTODED/1000),2),
...
PLP_MONTO=ROUND((PLP_MONTO/1000),2);

UPDATE DPEJECUCIONPROD SET 
EOP_COSTO=ROUND((EOP_COSTO/1000),2),
EOP_VALAGR=ROUND((EOP_VALAGR/1000),2);

UPDATE DPEJECUCIONVALAGRE SET 
EVA_MONTO=ROUND((EVA_MONTO/1000),2),
  EVA_TOTAL=ROUND((EVA_TOTAL/1000),2);

UPDATE DPEXPEDIENTE	SET 
EXP_MONTO=ROUND((EXP_MONTO/1000),2);

UPDATE DPGIROSCLI SET 
GIR_GASTO=ROUND((GIR_GASTO/1000),2),
GIR_MTOINT=ROUND((GIR_MTOINT/1000),2);

UPDATE DPGUIACARGA SET 
GTR_MTOFON=ROUND((GTR_MTOFON/1000),2);

UPDATE DPGUIATRANSP SET 
GTR_VALOR=ROUND((GTR_VALOR/1000),2),
GTR_VIATIC=ROUND((GTR_VIATIC/1000),2);

UPDATE DPHISMON SET 
HMN_VALOR=ROUND((HMN_VALOR/1000),2);

UPDATE DPINV SET 
INV_COSADQ=ROUND((INV_COSADQ/1000),2),
INV_COSFOB=ROUND((INV_COSFOB/1000),2),
INV_COSMER=ROUND((INV_COSMER/1000),2),
INV_PVPORG=ROUND((INV_PVPORG/1000),2);

UPDATE DPINVALQUILER SET 
ALQ_DEPOSI=ROUND((ALQ_DEPOSI/1000),2);

UPDATE DPINVCAPAPRECIOS SET 
CAP_PRECIO=ROUND((CAP_PRECIO/1000),2);

UPDATE DPINVCLASIFICA SET 
TIP_INCIDE=ROUND((TIP_INCIDE/1000),2);

UPDATE DPINVPLAABAST SET 
IPA_COSTO=ROUND((IPA_COSTO/1000),2);

UPDATE DPINVPROMOCION SET 
PRO_PRECIO=ROUND((PRO_PRECIO/1000),2);

UPDATE DPLIBINVDET SET 
DLI_COSANT=ROUND((DLI_COSANT/1000),2),
DLI_COSCOM=ROUND((DLI_COSCOM/1000),2),
DLI_COSENT=ROUND((DLI_COSENT/1000),2),
DLI_COSINV=ROUND((DLI_COSINV/1000),2),
DLI_COSSAL=ROUND((DLI_COSSAL/1000),2),
DLI_COSVTA=ROUND((DLI_COSVTA/1000),2),
DLI_COSPRO=ROUND((DLI_COSPRO/1000),2),
DLI_INPC=ROUND((DLI_INPC/1000),2),
DLI_IPC=ROUND((DLI_IPC/1000),2);

UPDATE DPLIBINVDETCAPAS SET 
CAP_ACTINPC=ROUND((CAP_ACTINPC/1000),2),
CAP_ACTIPC=ROUND((CAP_ACTIPC/1000),2),
CAP_INPC=ROUND((CAP_INPC/1000),2),
CAP_IPC=ROUND((CAP_IPC/1000),2);

UPDATE DPMOVCONTEO SET 
MDC_COSTO=ROUND((MDC_COSTO/1000),2);

UPDATE DPMOVINV SET 
MOV_COSTO=ROUND((MOV_COSTO/1000),2),
MOV_TOTAL=ROUND((MOV_TOTAL/1000),2),
MOV_PRECIO=ROUND((MOV_PRECIO/1000),2),
MOV_IMPOTR=ROUND((MOV_IMPOTR/1000),2),
MOV_MTOCOM=ROUND((MOV_MTOCOM/1000),2),
...
MOV_MTOCLA=ROUND((MOV_MTOCLA/1000),2);

UPDATE DPMOVINVCLASIF SET 
MCI_INCIDE=ROUND((MCI_INCIDE/1000),2),
MCI_TOTAL=ROUND((MCI_TOTAL/1000),2);

UPDATE DPMOVSERIAL SET 
MSR_PRECIO=ROUND((MSR_PRECIO/1000),2);

UPDATE DPORDENPRODUCC SET 
ORP_COSMAT=ROUND((ORP_COSMAT/1000),2),
ORP_COSVAA=ROUND((ORP_COSVAA/1000),2);

UPDATE DPPANELERP SET 
ERP_MONTO=ROUND((ERP_MONTO/1000),2);

UPDATE DPPARROQUIAS SET 
TARIFA=ROUND((TARIFA/1000),2);

UPDATE DPPERSONAL SET 
PER_CUOTA=ROUND((PER_CUOTA/1000),2),
PER_MTOCOB=ROUND((PER_MTOCOB/1000),2);

UPDATE DPPOSCOMANDA SET 
COM_PRECIO=ROUND((COM_PRECIO/1000),2),
COM_MTOIVA=ROUND((COM_MTOIVA/1000),2);

UPDATE DPPOSUSUARIO SET 
RDP_MONTO=ROUND((RDP_MONTO/1000),2);

UPDATE DPPRECIOS SET 
PRE_PRECIO=ROUND((PRE_PRECIO/1000),2);

UPDATE DPPRECIOSHIS SET 
PRE_PRECIO=ROUND((PRE_PRECIO/1000),2);

UPDATE DPPREMER SET 
MER_PRECIO=ROUND((MER_PRECIO/1000),2);

UPDATE DPPROVEEDOR SET 
PRO_LIMITE=ROUND((PRO_LIMITE/1000),2),
PRO_MTOVEN=ROUND((PRO_MTOVEN/1000),2);

UPDATE DPPROVEEDORPROG SET 
PGC_MONTO=ROUND((PGC_MONTO/1000),2),
PGC_MTOBAS=ROUND((PGC_MTOBAS/1000),2);

UPDATE DPPROVEEDORSUC SET 
SDP_VIATIC=ROUND((SDP_VIATIC/1000),2);

UPDATE DPRECIBOSCLI SET 
REC_VALCAM=ROUND((REC_VALCAM/1000),2),
REC_MONTO=ROUND((REC_MONTO/1000),2),
REC_MTOIVA=ROUND((REC_MTOIVA/1000),2);

UPDATE DPREGABASTEC SET 
RAB_MONTO=ROUND((RAB_MONTO/1000),2);

UPDATE DPTABCOMDET SET 
TCD_COL_A=ROUND((TCD_COL_A/1000),2),
TCD_COL_B=ROUND((TCD_COL_B/1000),2),
TCD_COL_C=ROUND((TCD_COL_C/1000),2),
TCD_COL_D=ROUND((TCD_COL_D/1000),2);
...
DOC_BASNET=ROUND((DOC_BASNET/1000),2),
DOC_MTOIVA=ROUND((DOC_MTOIVA/1000),2),
DOC_PAGEFE=ROUND((DOC_PAGEFE/1000),2);
...
VAA_MONTO=ROUND((VAA_MONTO/1000),2);

UPDATE DPVENDEDOR SET 
VEN_CUOTA=ROUND((VEN_CUOTA/1000),2),
VEN_MTOCOB=ROUND((VEN_MTOCOB/1000),2);

UPDATE EMPEDIDOMOV SET 
MPE_PRECIO=ROUND((MPE_PRECIO/1000),2),
MPE_TOTAL=ROUND((MPE_TOTAL/1000),2);
